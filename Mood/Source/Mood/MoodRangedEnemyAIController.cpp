...
// Sets default values
AMoodRangedEnemyAIController::AMoodRangedEnemyAIController()
{
...
void AMoodRangedEnemyAIController::BeginPlay()
{
	Super::BeginPlay();
...
void AMoodRangedEnemyAIController::OnPossess(APawn* InPawn)
{
